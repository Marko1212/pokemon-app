...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.searchPokemons = function (term) {
        ...
        return this.http.get(this.pokemonsUrl + "/?name=" + term).pipe(operators_1.tap(function (_) { return _this.log("found pokemons matching \"" + term + "\""); }), operators_1.catchError(this.handleError("search Pokemons", [])));
    };
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(url, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("deleted pokemon id=" + pokemon.id); }), operators_1.catchError(this.handleError("delete Pokemon")));
    };
    PokemonsService.prototype.updatePokemon = function (pokemon) {
        ...
        return this.http.put(this.pokemonsUrl, pokemon, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("updated pokemon id=" + pokemon.id); }), operators_1.catchError(this.handleError("update Pokemon")));
    };
